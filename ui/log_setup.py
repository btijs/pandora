...
DEFAULT_WIDTH = {"LoggingLevelnameStyle": LogLevel.get_max_logname_len(), "LoggingNameStyle": 20}
...
def init_logger(config_file, pandora_level, angr_level):
    ...
    logging.basicConfig(force=True, handlers=[handler], level=pandora_level.upper())
