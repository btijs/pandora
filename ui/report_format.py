...
class HTMLFormatter(BaseFormatter):
    ...
    badge_styles = {"DEBUG": "bg-success", "INFO": "bg-info text-dark", "WARNING": "bg-warning text-dark", "ERROR": "bg-danger", "CRITICAL": "bg-danger"}
...
#       Implemented formats            #
########################################
report_formats = {"html": HTMLFormatter, "log": LogFormatter}
...
class ReportFormatter:
    def __init__(self, report_data, report_fmt, reporter_level=LogLevel.INFO, max_ips=0):
        ...
        for plug in self.plugin_entries:
            ...
            self.plugins[plug["shortname"]] = {"fmt": fmt, "name": plug["name"], "desc": plug["desc"], "ips": defaultdict(set), "path": path}
